...
* Improved node addition
  ...
  - Ability to configure various node instance types with a "selection factor". The call to add node will then pick the type to use in function of the spot market prices and the "selection factor". (`Pull Request 18`_)
